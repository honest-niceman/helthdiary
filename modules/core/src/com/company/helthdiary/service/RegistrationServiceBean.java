...
public class RegistrationServiceBean implements RegistrationService {
     ...
     */
    private static final String DEFAULT_ROLE_ID = "34ac5b63-9745-0b29-5a39-7d7e2f877e2a";
    ...
    public RegistrationResult registerUser(String login, String password) {
        ...
        //Настроил в ролях дефолтную роль, поэтому автоматически законектиться роль с пользователем
