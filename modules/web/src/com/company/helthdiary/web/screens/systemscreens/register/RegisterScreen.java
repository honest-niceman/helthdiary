package com.company.helthdiary.web.screens.systemscreens.register;

import com.company.helthdiary.service.RegistrationService;
...
@UiController("helthdiary_RegisterScreen")
    ...
    public void onOkBtnClick(Button.ClickEvent event) {
        try {
            ...
            notifications.create(Notifications.NotificationType.TRAY)
                    .withCaption(
                            messages.getMessage(
                                    "com/company/helthdiary/web/screens/systemscreens/register/",
